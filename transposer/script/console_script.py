...
def parse_args():
    ...
    parser.add_argument('-i', '--in', dest='file_in', default=None, 
                        required=True, help='file from which to read input data')
    parser.add_argument('-o', '--out', dest='file_out', default=None,
